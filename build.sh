...
gcc -Wall -Wextra -g -std=c11 -I ./src ./src/db/scores.c ./src/entities/entities.c ./src/game/game.c ./src/render/render.c ./src/main.c -lm -o battlezone $(pkg-config --cflags --libs sdl2 SDL2_ttf sqlite3) # -g remove for prod
